...
import { useViewCategoryQuery } from "../users/service/redux/categorySlice";
import { useGetAllServicesQuery } from "../users/service/redux/serviceSlice";
        ...
        <section className=" grid lg:grid-cols-7  ">
          ...
          >
            <div className="flex gap-2 px-1 text-slate-800">
              ...
              <div className=" flex  shadow bg-gray-300 flex-1 rounded-sm">
                <div className=" flex-1">
                  <input
                    type="text"
                    name=""
                    id=""
                    className="  flex-1 p w-full p-2 text-gray-800  focus:outline-none rounded-sm text-sm"
